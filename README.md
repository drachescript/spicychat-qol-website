...
The interactive demo's real extension Settings source is automatically mirrored from the public extension repository by `.github/workflows/sync-demo-source.yml`, avoiding a runtime dependency on multiple raw-GitHub requests for every visitor.
